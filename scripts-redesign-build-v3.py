...
IMG = {k: uri(v) for k, v in {
    "hero": "/assets/images/services/brows.webp",
...
<div style="background:#7a1f14;color:#fff;font:700 11px/1.5 ui-monospace,Menlo,monospace;letter-spacing:.14em;text-transform:uppercase;text-align:center;padding:7px 14px">
  Draft redesign v3 &middot; not live &middot; fallingwatersdayspa.com is unchanged
</div>
...
<section class="hero">
  <img src="{IMG['hero']}" alt="A lash and brow treatment in progress at Falling Waters Day Spa in Draper, Utah" width="1400" height="900">
...
out = pathlib.Path("/tmp/fw-v3.html"); out.write_text(HTML, encoding="ascii")
