...
SERVICES = [
    ...
    ("Skin Care &amp; Facials", "HydraFacial, chemical peels, microdermabrasion &amp; custom facials for radiant skin.", "65", "/services/facials", "team2"),
...
PACKAGES = [
    ...
    ("The Birthday Glow Experience", "210", "Your day, your way: 60 min custom facial, 50 min Swedish massage, and a floral arrangement to take home. You deserve it.", None),
]
REVIEWS = [
...
def svc(i, s):
    ...
    return f'''
      <a class="svc rv" href="{href}" style="transition-delay:{i*55}ms">
        ...
        <span class="svc-go" aria-hidden="true">View &amp; book</span>
...
.svc-go {{ position:absolute; left:50%; top:50%; z-index:2; transform:translate(-50%,-40%);
...
.svc:hover .svc-go, .svc:focus-visible .svc-go {{ opacity:1; transform:translate(-50%,-50%); }}
...
<div style="background:#7a1f14;color:#fff;font:700 11px/1.5 ui-monospace,Menlo,monospace;letter-spacing:.14em;text-transform:uppercase;text-align:center;padding:7px 14px">
  Draft redesign v7 &middot; not live &middot; fallingwatersdayspa.com is unchanged
</div>
...
<section id="team"><div class="wrap">
  <div class="head rv">
    <div><span class="eyebrow">The people</span><h2 class="display">You don&rsquo;t book a spa. You book a person.</h2></div>
  ...
  <div class="team-g">
    ...
    <div class="tm rv" style="transition-delay:75ms"><figure class="ph"><img src="{IMG['facial']}" alt="Skincare products and tools at Falling Waters" loading="lazy" decoding="async" width="600" height="800"></figure><h3>Licensed Aestheticians</h3><p>HydraFacial, peels &amp; custom facials.</p></div>
...
<section class="dark" id="reviews"><div class="wrap">
  <div class="rating rv">
    ...
    <p class="rating-lede">Every quote below is a real, published Google review. Nothing is paraphrased.</p>
  </div>
...
out = pathlib.Path("/tmp/fw-v7.html"); out.write_text(HTML, encoding="ascii")
