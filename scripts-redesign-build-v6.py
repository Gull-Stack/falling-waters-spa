...
IMG = {k: uri(v) for k, v in {
    "hero": "/assets/images/services/waxing.webp",
...
PACKAGES = [
    ("The Ultimate Spa Day", "207", "The full-body reset: 50-minute Swedish massage, 60-minute custom facial, and a luxury spa pedicure. Relax, refresh, renew.", "couples"),
...
<div style="background:#7a1f14;color:#fff;font:700 11px/1.5 ui-monospace,Menlo,monospace;letter-spacing:.14em;text-transform:uppercase;text-align:center;padding:7px 14px">
  Draft redesign v6 &middot; not live &middot; fallingwatersdayspa.com is unchanged
</div>
...
<section class="hero">
  <img src="{IMG['hero']}" alt="A therapist at work in a treatment room at Falling Waters Day Spa in Draper, Utah" width="1400" height="900">
...
<section id="team"><div class="wrap">
  ...
  <div class="rule" style="margin:clamp(2.5rem,5vw,3.5rem) 0 clamp(2rem,4vw,2.75rem)"></div>
  ...
  <div class="cta-row rv">
    ...
    <span class="fine">4.4 stars across 136+ Google reviews.</span>
  </div>
</div></section>
...
<section class="dark visit" id="visit">
  <img src="{IMG['massage']}" alt="" aria-hidden="true">
  <div class="wrap">
    <div class="head rv">
...
out = pathlib.Path("/tmp/fw-v6.html"); out.write_text(HTML, encoding="ascii")
