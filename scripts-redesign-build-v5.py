...
<div style="background:#7a1f14;color:#fff;font:700 11px/1.5 ui-monospace,Menlo,monospace;letter-spacing:.14em;text-transform:uppercase;text-align:center;padding:7px 14px">
  Draft redesign v5 &middot; not live &middot; fallingwatersdayspa.com is unchanged
</div>
...
<section id="services"><div class="wrap">
  ...
  <div class="cta-row rv">
    <a class="btn btn-ink" href="{BOOK}">Book any service</a>
...
<section id="team"><div class="wrap">
  ...
  <div class="cta-row rv">
    <a class="btn btn-ink" href="{BOOK}">Book with our team</a>
...
out = pathlib.Path("/tmp/fw-v5.html"); out.write_text(HTML, encoding="ascii")
