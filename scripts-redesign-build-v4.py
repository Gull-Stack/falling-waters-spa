...
<div style="background:#7a1f14;color:#fff;font:700 11px/1.5 ui-monospace,Menlo,monospace;letter-spacing:.14em;text-transform:uppercase;text-align:center;padding:7px 14px">
  Draft redesign v4 &middot; not live &middot; fallingwatersdayspa.com is unchanged
</div>
...
<section class="dark" id="team"><div class="wrap">
  <div class="head rv">
  ...
  <p class="fine rv" style="margin-top:1.5rem">4.4 stars across 136+ Google reviews.</p>
</div></section>
...
out = pathlib.Path("/tmp/fw-v4.html"); out.write_text(HTML, encoding="ascii")
